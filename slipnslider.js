...
/* And now for Slipnslide! */

var max = 0;

$('.slipnslider li').each(function(index){
	$(this).addClass('slide' + index).addClass('animated').addClass('inactive');
	max = index;
});

$('.slipnslider .slide0').removeClass('inactive').addClass('active');

function next_slide() {
	var next = $('.slipnslider .active').index() + 1;
	if(next > max) {
		next = 0;
	}
	$('.slipnslider .active').removeClass('active back').addClass('inactive');
	$('.slipnslider .slide'+next).removeClass('inactive back').addClass('active');
}
...
function prev_slide() {
	...
	$('.slipnslider .active').removeClass('active back').addClass('inactive back');
	$('.slipnslider .slide'+next).removeClass('inactive back').addClass('active back');
}
